                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="mb-4 grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    >
                                        Assigné à{" "}
                                        {!isManager && "(Réservé aux managers)"}
                                    </label>
                                    <select
                                        id="assignee"
                            ...
                            <div className="col-span-2 mt-2">
                                <div className="rounded-md bg-blue-50 p-3 text-sm text-blue-700 dark:bg-blue-900/30 dark:text-blue-300">
                                    <p>
                                        Note: Le statut de la tâche est
                                        automatiquement déterminé par la colonne
                            ...
                            <div className="mb-6 grid grid-cols-2 gap-4">
                                ...
                                {task.tags.length > 0 && (
                                    <div className="flex items-start">
                                        <Tag
                                            size={18}
                                            className="mr-2 mt-0.5 text-violet-500"
                                        />
                                        <div>
                                            <div className="text-sm font-medium text-gray-700">
                                                Tags
                                ...
                                <div className="mb-6">
                                    ...
                                    {task.attachments.length > 0 ? (
                                        ...
                                        <p className="rounded-md bg-gray-50 p-3 text-sm italic text-gray-500 dark:bg-gray-800 dark:text-gray-400">
                                            Aucune pièce jointe. Ajoutez des
                                            fichiers pour partager des
                                            ressources.
                                        </p>
                                    )}
                                </div>
